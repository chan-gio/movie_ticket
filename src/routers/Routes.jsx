...
const LoginPage = lazy(() => import('../pages/UserPages/Auth/LoginPage.jsx'));
...
const routeConfig = [
  ...
  {
    path: '/admin/manage_user/details/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageUserDetails />
        </Admin>
      </ProtectedAdminRoute>
    )
  },
  {
    path: '/admin/manage_movie',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageMovie />
  ...
  {
    path: '/admin/manage_movie/edit/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminMovieForm />
  ...
  {
    path: '/admin/manage_cinema/add_cinema',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminAddCinemaForm />
  ...
  {
    path: '/admin/manage_cinema/edit_cinema/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminEditCinemaForm />
  ...
  {
    path: '/admin/manage_rooms/:cinemaId',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageRoom />
  ...
  {
    path: '/admin/manage_seats/edit_room/:roomId',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageSeats />
  ...
  {
    path: '/admin/manage_showtime/add',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageShowtimeForm isEditMode={false} />
        </Admin>
      </ProtectedAdminRoute>
    )
  },
  {
    path: '/admin/manage_showtime/edit/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageShowtimeForm isEditMode={true} />
        </Admin>
      </ProtectedAdminRoute>
    )
  },
  ...
  {
    path: '/admin/manage_booking/details/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageBookingDetails />
        </Admin>
      </ProtectedAdminRoute>
    )
  },
  ...
  {
    path: '/admin/manage_coupon/add',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageCouponForm isEditMode={false} />
        </Admin>
      </ProtectedAdminRoute>
    )
  },
  {
    path: '/admin/manage_coupon/edit/:id',
    element: (
      <ProtectedAdminRoute>
        <Admin>
          <AdminManageCouponForm isEditMode={true} />
        </Admin>
      </ProtectedAdminRoute>
    )
  }
