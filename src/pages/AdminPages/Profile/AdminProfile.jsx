        ...
        <Col xs={24} lg={8}>
          <Card className={styles.card}>
            <div style={{ textAlign: 'center' }}>
              <Avatar size={150} icon={<UserOutlined />} src="https://icon-library.com/images/default-user-icon/default-user-icon-4.jpg" className={styles.profileImage} />
            ...
            <div style={{ marginTop: 24 }}>
              <Statistic title="Login Count" value={adminProfile.loginCount} prefix={<SafetyOutlined />} style={{ marginBottom: 16 }} />
              <Statistic title="Last Login" value={adminProfile.lastLogin} prefix={<MailOutlined />} />
            </div>
          </Card>
        </Col>
        <Col xs={24} lg={16}>
